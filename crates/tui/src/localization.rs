...
pub enum MessageId {
    ...
    // --- History / transcript render labels ---
    RenderThinkingLabel,
    RenderToolStatusRunning,
    RenderToolStatusDone,
    RenderToolStatusFailed,
    RenderToolTitleShell,
    RenderToolTitlePlan,
    RenderToolTitleReview,
    RenderToolTitlePatch,
    RenderToolTitleWorkspace,
    RenderToolLive,
    RenderToolNext,
    RenderToolIssue,
    RenderDetailsHidden,
    RenderAltVDetails,
    RenderCtrlBShellControls,
    RenderNoOutput,
    RenderSource,
    RenderStartedByYou,
    RenderTime,
    ...
    RenderCellTypeNote,
    RenderCellTypeError,
    RenderCellTypeReasoning,
    RenderCellTypeMessage,
    RenderCellTypeSubAgent,
}
...
pub const ALL_MESSAGE_IDS: &[MessageId] = &[
    ...
    MessageId::RenderThinkingLabel,
    MessageId::RenderToolStatusRunning,
    MessageId::RenderToolStatusDone,
    MessageId::RenderToolStatusFailed,
    MessageId::RenderToolTitleShell,
    MessageId::RenderToolTitlePlan,
    MessageId::RenderToolTitleReview,
    MessageId::RenderToolTitlePatch,
    MessageId::RenderToolTitleWorkspace,
    MessageId::RenderToolLive,
    MessageId::RenderToolNext,
    MessageId::RenderToolIssue,
    MessageId::RenderDetailsHidden,
    MessageId::RenderAltVDetails,
    MessageId::RenderCtrlBShellControls,
    MessageId::RenderNoOutput,
    MessageId::RenderSource,
    MessageId::RenderStartedByYou,
    MessageId::RenderTime,
    MessageId::RenderFile,
    MessageId::RenderTarget,
    MessageId::RenderSummary,
    MessageId::RenderIssues,
    MessageId::RenderNone,
    MessageId::RenderNote,
    MessageId::RenderNoSummary,
    MessageId::RenderViaModel,
    MessageId::RenderCellTypeNote,
    MessageId::RenderCellTypeError,
    MessageId::RenderCellTypeReasoning,
    MessageId::RenderCellTypeMessage,
    MessageId::RenderCellTypeSubAgent,
];
...
fn english(id: MessageId) -> &'static str {
    match id {
        ...
        MessageId::RenderThinkingLabel => "thinking",
        MessageId::RenderToolStatusRunning => "running",
        MessageId::RenderToolStatusDone => "done",
        MessageId::RenderToolStatusFailed => "failed",
        MessageId::RenderToolTitleShell => "Shell",
        MessageId::RenderToolTitlePlan => "Plan",
        MessageId::RenderToolTitleReview => "Review",
        MessageId::RenderToolTitlePatch => "Patch",
        MessageId::RenderToolTitleWorkspace => "Workspace",
        MessageId::RenderToolLive => "live",
        MessageId::RenderToolNext => "next",
        MessageId::RenderToolIssue => "issue",
        MessageId::RenderDetailsHidden => "details hidden",
        MessageId::RenderAltVDetails => "Alt+V for details",
        MessageId::RenderCtrlBShellControls => "  Ctrl+B opens shell controls.",
        MessageId::RenderNoOutput => "  (no output)",
        MessageId::RenderSource => "source",
        MessageId::RenderStartedByYou => "started by you",
        MessageId::RenderTime => "time",
        MessageId::RenderFile => "file",
        MessageId::RenderTarget => "target",
        MessageId::RenderSummary => "Summary:",
        MessageId::RenderIssues => "Issues",
        MessageId::RenderNone => "  (none)",
        MessageId::RenderNote => "Note",
        MessageId::RenderNoSummary => "(no summary)",
        MessageId::RenderViaModel => "via {model}",
        MessageId::RenderCellTypeNote => "Note",
        MessageId::RenderCellTypeError => "Error",
        MessageId::RenderCellTypeReasoning => "Reasoning",
        MessageId::RenderCellTypeMessage => "Message",
        MessageId::RenderCellTypeSubAgent => "Sub-agent",
    }
}
...
fn japanese(id: MessageId) -> Option<&'static str> {
    Some(match id {
        ...
        // TODO(l10n): add Japanese translations for render labels
        MessageId::RenderThinkingLabel => "thinking",
        MessageId::RenderToolStatusRunning => "running",
        MessageId::RenderToolStatusDone => "done",
        MessageId::RenderToolStatusFailed => "failed",
...
fn chinese_simplified(id: MessageId) -> Option<&'static str> {
    Some(match id {
        ...
        MessageId::RenderThinkingLabel => "思考中",
        MessageId::RenderToolStatusRunning => "运行中",
        MessageId::RenderToolStatusDone => "完成",
        MessageId::RenderToolStatusFailed => "失败",
        MessageId::RenderToolTitleShell => "Shell",
        MessageId::RenderToolTitlePlan => "规划",
        MessageId::RenderToolTitleReview => "审查",
        MessageId::RenderToolTitlePatch => "补丁",
        MessageId::RenderToolTitleWorkspace => "工作区",
        MessageId::RenderToolLive => "进行中",
        MessageId::RenderToolNext => "下一步",
        MessageId::RenderToolIssue => "问题",
        MessageId::RenderDetailsHidden => "详情已隐藏",
        MessageId::RenderAltVDetails => "Alt+V 查看详情",
        MessageId::RenderCtrlBShellControls => "  Ctrl+B 打开 Shell 控制。",
        MessageId::RenderNoOutput => "  （无输出）",
        MessageId::RenderSource => "来源",
        MessageId::RenderStartedByYou => "由你启动",
        MessageId::RenderTime => "耗时",
        MessageId::RenderFile => "文件",
        MessageId::RenderTarget => "目标",
        MessageId::RenderSummary => "总结：",
        MessageId::RenderIssues => "问题",
        MessageId::RenderNone => "  （无）",
        MessageId::RenderNote => "备注",
        MessageId::RenderNoSummary => "（无摘要）",
        MessageId::RenderViaModel => "通过 {model}",
        MessageId::RenderCellTypeNote => "备注",
        MessageId::RenderCellTypeError => "错误",
        MessageId::RenderCellTypeReasoning => "推理",
        MessageId::RenderCellTypeMessage => "消息",
        MessageId::RenderCellTypeSubAgent => "子代理",
    })
}
...
fn portuguese_brazil(id: MessageId) -> Option<&'static str> {
    Some(match id {
        ...
        // TODO(l10n): add Portuguese translations for render labels
        MessageId::RenderThinkingLabel => "thinking",
        MessageId::RenderToolStatusRunning => "running",
        MessageId::RenderToolStatusDone => "done",
        MessageId::RenderToolStatusFailed => "failed",
